...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Experience authentic Italian cuisine in an elegant atmosphere. Our chefs craft each dish with passion using the finest ingredients, creating memorable dining experiences for every guest.',
  contactEmail: 'info@bellavista.com',
  contactPhone: '+1 (555) 234-5678',
  contactAddress: '456 Culinary Lane, Downtown',
  ...
  copyrightText: '© 2024 Bella Vista. All rights reserved.',
  madeWithText: 'with love in our kitchen',
  ...
  linkHelp: 'Dining Guide',
  linkHelpHref: '/guide',
  linkCommunity: 'Events',
  linkCommunityHref: '/events',
  linkTutorials: 'Cooking Classes',
  linkTutorialsHref: '/classes',
  linkWebinars: 'Wine Tastings',
  linkWebinarsHref: '/tastings',
  linkCaseStudies: 'Catering',
  linkCaseStudiesHref: '/catering',
  linkStatus: 'Reservations',
  linkStatusHref: '/reservations',
