...
const DEFAULT_HERO = {
  ...
  testimonialText:
    "Bella Vista exceeded all our expectations. The ambiance, service, and food were absolutely perfect. It's become our go-to place for special celebrations.",
