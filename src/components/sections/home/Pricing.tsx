...
const DEFAULT_PRICING = {
  badge: 'Dining Packages',
  mainTitle: 'Exceptional Dining',
  mainTitleHighlight: 'Experiences',
  mainDescription:
    'Choose from our carefully curated dining experiences. Each package is designed to provide unforgettable moments with authentic Italian cuisine and impeccable service.',
  billingMonthly: 'Per Person',
  billingAnnual: 'Group Booking',
  billingAnnualBadge: 'Save 15%',
  plan1Name: 'Classic Dinner',
  plan1Description: 'Perfect for intimate dining and casual occasions',
  plan1Price: '$45',
  plan1CTA: 'Reserve Table',
  plan1CTAHref: '/reservations',
  plan2Name: 'Premium Experience',
  plan2Description: 'Our signature dining with wine pairings',
  plan2Price: '$85',
  plan2Period: '/person',
  plan2Badge: 'Most Popular',
  plan2CTA: 'Book Experience',
  plan2CTAHref: '/reservations',
  plan2Trial: 'Includes wine pairing • Complimentary dessert',
  plan3Name: "Chef's Table",
  plan3Description: 'Exclusive culinary journey with our head chef',
  plan3Price: '$150',
  plan3Badge: 'Exclusive',
  plan3CTA: 'Reserve Now',
  plan3CTAHref: '/reservations',
  bottomTitle: 'Planning a special event?',
  bottomDescription:
    'We offer custom catering and private dining experiences for weddings, corporate events, and special celebrations. Let us create an unforgettable culinary experience for your guests.',
  bottomCTA: 'Contact Events Team',
